...
- `.agents/state/TODO.md`, em iterações não triviais;
- `.agents/state/LESSONS.md`, se houver aprendizagem reutilizável;
- `.agents/state/HANDOFF.md`, em tarefas não triviais;
- `.agents/state/EVIDENCE.md` ou resposta final com resumo da auditoria.
