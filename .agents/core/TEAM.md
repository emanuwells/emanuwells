...
Uma única IA pode executar vários papéis, mas deve separar responsabilidades mentalmente e no relatório final quando o risco justificar. Em tarefas médias, altas, críticas ou multi-papel, usar `.agents/core/ORCHESTRATOR.md` para coordenar sequência, handoff e validações.
