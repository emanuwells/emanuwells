...
export const projects = {
  ...
  privateLabel: { pt: "Case study privado", en: "Private case study" } as Bi,
  items: [
    {
      id: "wells-os",
      ...
      githubUrl: "https://github.com/emanuwells/WELLS_OS",
      isPrivate: false,
    },
    {
      id: "data-paladin",
      name: { pt: "Data Paladin", en: "Data Paladin" } as Bi,
      description: {
        pt: "Limpeza e normalização do catálogo municipal com vocabulários controlados e checklist de segurança.",
        en: "Municipal catalogue cleaning and normalization with controlled vocabularies and a safety checklist.",
      } as Bi,
    ...
    {
      id: "overseer-warden",
      name: { pt: "Overseer + Warden", en: "Overseer + Warden" } as Bi,
      description: {
        pt: "Observabilidade de pipelines e de servidores — dois sistemas complementares que vigiam sem tocar no código de produção.",
        en: "Pipeline and server observability — two complementary systems that watch without touching production code.",
      } as Bi,
      tags: ["Python", "PHP", "Slack"],
      isPrivate: true,
    },
    {
      id: "wells-api",
    ...
    {
      id: "wells-bi",
      name: { pt: "WELLS_BI", en: "WELLS_BI" } as Bi,
      description: {
        pt: "Camada analítica com Power BI, DAX e Power Query M sobre o datalake municipal.",
        en: "Analytics layer with Power BI, DAX and Power Query M over the municipal data lake.",
      } as Bi,
      tags: ["Power BI", "DAX", "Power Query M"],
      isPrivate: true,
    },
    {
      id: "vacation-mode",
      ...
      description: {
        pt: "Ferramenta interna de gestão de ausências e cobertura operacional durante férias.",
        en: "Internal tool for absence management and operational coverage during holidays.",
      } as Bi,
      tags: ["PHP", "JavaScript"],
      isPrivate: true,
    },
